...
// Squeeze together
	...
	parent->Rear_Smooth_Move(6, 2.9, 0, 110, 33, -105, 4.7, 2.9, -2, 110, 33, -105, TimeConstant);
	delay(100); 
...
void RubiksControl::Rotate()
{
	...
	// rotate again
	parent->Rear_Smooth_Move(  4.3, 2.9, -3, 110, 0, -105,               4.1, 2.9, -3, 105, 50, -105,           TimeConstant); //rotate
	delay(100);
